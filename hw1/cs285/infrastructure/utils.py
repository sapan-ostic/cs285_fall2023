...
def sample_trajectory(env, policy, max_path_length, render=False):
    ...
    while True:
        ...
        observation = ptu.from_numpy(ob)  # HINT: this is a pytorch tensor
        action_dist = policy(observation)  # HINT: this is a pytorch distribution
        ac = action_dist.sample().cpu().numpy() # HINT: this is a numpy array
        ac = ac[0]
